...
$dotenv->load();
defined('BASEPATH') || define('BASEPATH', "temp");
...
$config = [
     ...
     */
    'technicalcontact_name' => 'Rhombus IT',
    'technicalcontact_email' => 'it@rhombuspower.com',
     ...
     */
    'secretsalt' => getenv('RB_SAML_SECRET_SALT'),
     ...
     */
    'auth.adminpassword' => getenv('RB_SAML_ADMIN_PASSWORD'),
     ...
     */
    'errors.show_function' => ['\SimpleSAML\Error\Rb_Error', 'capture_error'],
     ...
     */
    'session.duration' => 4 * (60 * 60), // 8 hours.
     ...
     */
    'session.datastore.timeout' => (2 * 60 * 60), // 4 hours
...
if(RB_SAML_DEBUG=="TRUE"){
    unset($config['errors.show_function']);
}