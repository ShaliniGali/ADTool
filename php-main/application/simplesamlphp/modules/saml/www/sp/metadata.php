...
$rbadminaccess = array_key_exists('rbsp', $_REQUEST) && $_REQUEST['rbsp'] == 'metadata';

$config = \SimpleSAML\Configuration::getInstance();
if ($config->getBoolean('admin.protectmetadata', false) && !$rbadminaccess) {
...
if (array_key_exists('output', $_REQUEST) && $_REQUEST['output'] == 'xhtml') {
    ...
    if ($rbadminaccess) {
        $spmetadata = $t->data['metadataflat'];
        return;
    }
    $t->show();
} else {
