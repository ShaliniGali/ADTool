...
<div class="content-wrapper">
    <header>
        <?php $this->load->view('SOCOM/header_buttons_view',
            array('current_page'=>'PB Comparison', 'page' => 'pb_comparison', 'page_summary_path' => 'pb_comparison')
        );?>
    </header>
    <div class="grey-background">
        <div class="d-flex flex-row align-items-center">
            ...
            <div class="d-flex flex-column">
                ...
                <div>
                    <button
                        id="pb-comparison-filter-compare"
                        class="bx--btn bx--btn--primary header-button bx--btn--field"
                        type="button"
            ...
            <div class="bx--form-item" id="pb-common-range-toggle-container" hidden>
                <input class="bx--toggle-input" id="pb-common-range-toggle" type="checkbox" onchange="common_range_toggle()">
                <label class="bx--toggle-input__label" for="pb-common-range-toggle">
...
<?php
    $js_files = array();
    $CI = &get_instance();
    $js_files['s_home'] = ['actions/SOCOM/pb_comparison.js','custom'];
    $CI->load->library('RB_js_css');
    $CI->rb_js_css->compress($js_files);
?>
