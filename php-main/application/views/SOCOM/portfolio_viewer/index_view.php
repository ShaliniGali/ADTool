...
$js_files['portfolio'] = ['actions/SOCOM/portfolio_viewer/portfolio.js', 'custom'];
$js_files['drilldown_filter'] = ['actions/SOCOM/portfolio_viewer/drilldown_filter.js', 'custom'];
$js_files['dropdown_filter'] = ['actions/SOCOM/portfolio_viewer/dropdown_filter.js', 'custom'];
            ...
            <div class="bx--tab-content tab-content-background">
                <div id="tab-link-budget-trend-overview-container" class="tab-budget-trend-overview-container tab-content-wrapper d-flex"
                    ...
                    <div class="d-flex flex-column w-100">
                        <?php $this->load->view('SOCOM/portfolio_viewer/budget_trend_overview_view.php'); ?>
                    </div>
                ...
                <div id="tab-panel-program-execution-drilldown-container" class="tab-program-execution-drilldown-container"
                    ...
                    <div class="d-flex flex-column w-100">
                        <?php $this->load->view('SOCOM/portfolio_viewer/program_execution_drilldown_view.php'); ?>
                    </div>
                </div>
                <div id="tab-panel-compare-programs-container" class="tab-compare-programs-container"
                    ...
                    aria-hidden="true" hidden>
                    <div class="d-flex flex-column w-100">
                        <?php $this->load->view('SOCOM/portfolio_viewer/compare_programs_view.php'); ?>
                    </div>
                </div>
            </div>
        </div>
