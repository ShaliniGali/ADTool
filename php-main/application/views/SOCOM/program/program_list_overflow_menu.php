...
<div  class="bx--overflow-menu" id="option_panel">
	<button style="background: #646363;" class="bx--overflow-menu__trigger bx--tooltip--left" aria-haspopup="true" aria-expanded="false" id="" aria-controls="list-menu">
	...
	<div class="bx--overflow-menu-options" tabindex="-1" role="menu" aria-labelledby="list-menu-trigger" data-floating-menu-direction="bottom" id="<?=$id ?? ''?>">
		<ul class="bx--overflow-menu-options__content">
			...
			<li class="bx--overflow-menu-options__option">
				<button class="bx--overflow-menu-options__btn" role="delete">
					<span class="bx--overflow-menu-options__option-content">
						Delete
					</span>
				</button>
