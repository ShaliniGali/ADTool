<div id="coa-detailed-summary-jca-alignment-container-<?= $table_id ?>" class="white-background">
    <h2 class="pt-2 pb-2" style="text-align: center;">Detailed Summary of <strong><?= $title; ?><strong></h2>
    <div class="d-flex flex-row justify-content-between p-2">
        <div id="coa-detailed-summary-jca-alignment-<?= $table_id ?>-container" class="w-100">
            <div data-content-switcher class="bx--content-switcher" role="tablist" aria-label="Demo switch content" style="max-width: 16rem;">
                <button class="bx--content-switcher-btn bx--content-switcher--selected"
                    data-target="#coa-detailed-summary-jca-alignment-chart-<?= $table_id ?>-container" role="tab"  aria-selected="true"  >
                    <span class=bx--content-switcher__label>Visual</span>
                </button>
                <button class="bx--content-switcher-btn"
                    data-target="#coa-detailed-summary-jca-alignment-table-<?= $table_id ?>-container" role="tab"  >
        ...
        <div class="d-flex flex-column">
            <div class="d-flex flex-row">
                <div id="jca-alignment-lvl1-<?= $table_id ?>-dropdown" class="d-flex flex-column mr-3">
                    ...
                    <select
                            ...
                            onchange="dropdown_onchange(<?= $table_id ?>, 'lvl1', 'jca-alignment', 'summary', <?= $scenario_id ?>)"
                            multiple="multiple"
                            >
                ...
                <div id="jca-alignment-lvl2-<?= $table_id ?>-dropdown" class="d-flex flex-column mr-3">
                    ...
                    <select
                            ...
                            combination-id=""
                            class="selection-dropdown"
                            onchange="dropdown_onchange(<?= $table_id ?>, 'lvl2', 'jca-alignment', 'summary', <?= $scenario_id ?>)"
                            multiple="multiple"
                            >
                        <option option="ALL" selected>ALL</option>
                ...
                <div id="jca-alignment-lvl3-<?= $table_id ?>-dropdown" class="d-flex flex-column">
                    ...
                    <select
                            ...
                            combination-id=""
                            class="selection-dropdown"
                            onchange="dropdown_onchange(<?= $table_id ?>, 'lvl3', 'jca-alignment', 'summary', <?= $scenario_id ?>)"
                            multiple="multiple"
                            >
                        <option option="ALL" selected>ALL</option>
                    </select>
            ...
            <div class="d-flex flex-row mt-2 justify-content-end">
                <input id="jca-alignment-lvl3-details-<?= $table_id ?>" class="checkbox mr-2 mb-1 flex-row" type='checkbox' onclick="dropdown_onchange(<?= $table_id ?>, 'level-checkbox', 'jca-alignment', 'summary', <?= $scenario_id ?>)" /> 
                <label for="jca-alignment-lvl3-details-<?= $table_id ?>" class="mb-1 bx--label medium-label flex-row">3rd Level Details</label>
            </div>
        </div>
    </div>
    <div id="coa-detailed-summary-jca-alignment-chart-<?= $table_id ?>-container" class="d-flex flex-row mt-2">
        <div class="w-50 mr-2">
            <div class="p-2 d-flex flex-row justify-content-between">
                <h4>Include:</h4><h4>FYDP: <span id="jca-alignment-inc-fydp-<?= $table_id ?>"></span></h4>
            </div>
            <div class="w-100 d-flex flex-row">
                <div id="coa-detailed-summary-jca-alignment-included-chart-<?= $table_id ?>" class="pie-chart-container w-100"></div>
            </div>
        </div>
        <div class="w-50">
        <div class="p-2 d-flex flex-row justify-content-between">
                <h4>Exclude:</h4><h4>FYDP: <span id="jca-alignment-exc-fydp-<?= $table_id ?>"></span></h4>
            </div>
            <div class="w-100 d-flex flex-row">
                <div id="coa-detailed-summary-jca-alignment-excluded-chart-<?= $table_id ?>" class="pie-chart-container w-100"></div>
            </div>
        </div>
    </div>
    <div id="coa-detailed-summary-jca-alignment-table-<?= $table_id ?>-container" class="d-flex flex-row mt-2" hidden>
        <div class="w-50 mr-2">
            <div class="p-2 d-flex flex-row justify-content-between">
                <h4>Include:</h4>
            </div>
            <div class="w-100 d-flex flex-column p-2">
                <div class="">
                    <h5>Covered</h5>
                    <table id="coa-detailed-summary-jca-alignment-included-covered-table-<?= $table_id ?>" class="bx--data-table w-100" >
                        <thead>
                            <tr>
                ...
                <div class="mt-2">
                    <h5>Non-covered</h5>
                    <table id="coa-detailed-summary-jca-alignment-included-noncovered-table-<?= $table_id ?>" class="bx--data-table w-100" >
                        <thead>
                            <tr>
        ...
        <div class="w-50">
            ...
            <div class="w-100 d-flex flex-column p-2">
                <div>
                    <h5>Covered</h5>
                    <table id="coa-detailed-summary-jca-alignment-excluded-covered-table-<?= $table_id ?>" class="bx--data-table w-100">
                        <thead>
                            <tr>
                                <?php foreach ($headers['covered'] as $header): ?>
                                    <th>
                ...
                <div  class="mt-2" hidden>
                    <h5>Non-covered</h5>
                    <table id="coa-detailed-summary-jca-alignment-excluded-noncovered-table-<?= $table_id ?>" class="bx--data-table w-100 mt-2">
                        <thead>
                            <tr>
                                <?php foreach ($headers['noncovered'] as $header): ?>
                                    <th>
