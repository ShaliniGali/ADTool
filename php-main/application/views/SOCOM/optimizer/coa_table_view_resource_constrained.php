<div id="coa-save-container-rc-<?=$n?>" class="d-flex flex-column justify-content-between">
    <div class="d-flex">
        <h5 id="coa-save-rc-<?=$n?>" class="coa-save"></h5>
    </div>
    <div id="coa-manual-override-modal-button-container-rc-<?=$n?>"
        class="d-flex justify-content-between pr-2"
    ></div>
</div>
<table id="coa-table-rc-<?=$n?>" class="display" style="width:100%">
    <thead>
        <tr>
            <th></th>
            <th>PROPOSED CUTS $K</th>
            <th>EXCESS CUTS $K</th>
        </tr>
    </thead>
    <tbody>
