...
<div class="content-wrapper">
    <header>
        <?php $this->load->view('SOCOM/header_buttons_view',
            array('current_page'=>'ZBT Summary', 'page' => 'zbt', 'page_summary_path' => 'zbt_summary', 'subapp_pom_year_zbt' => $subapp_pom_year_zbt, 'subapp_pom_year_issue' => $subapp_pom_year_issue)
        );?>
    </header>
        ...
        <div class="d-flex flex-row justify-content-between">
            ...
            <div class="w-33 pie-chart-container">
                <div class="exec-container-child-1 h-100">
                    <span class="bold-labels" style="margin-left:0px;">Number of ZBTs:</span>
