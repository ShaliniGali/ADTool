<div class="bx--col">
    <div data-date-picker data-date-picker-type="single" class="bx--date-picker bx--date-picker--single">
        <div class="bx--date-picker-container">
            <label for="date-picker-1" class="bx--label"><?php echo (isset($label) ? $label : '');?></label>
            <div class="bx--date-picker-input__wrapper <?php echo (isset($class) ? $class : '');?>">
                <input type="text" id="<?php echo (isset($id) ? $id : '');?>" class="bx--date-picker__input" pattern="\d{1,2}/\d{1,2}/\d{4}" placeholder="<?php echo (isset($placeholder) ? $placeholder : '');?>" data-date-picker-input />
