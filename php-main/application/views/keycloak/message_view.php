    ...
    <div class="row pt-3">
        <?php if ($template === 1): ?>
            <?= printout_message(
                ...
                '<h4 class="pt-4 mt-4 text-capitalize text-muted">Failed to login! <br><br> Please contact Rhombus Power KEYCLOAK administrator.</h4>'); ?>
        ...
        <?php elseif ($template === 3): ?>
            <?= printout_message(
                ...
                . '<div class="row justify-content-center w-100"><button id="reqaccess" class="btn btn-success mt-4" onclick="request_rb_kc()">Request Account</button></div>'; ?>
        <?php endif; ?>
        <?php echo $template; ?>
    </div>
</div>
