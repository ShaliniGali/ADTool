...
<div class="px-3">
  <table id="accountsTable" class="table table-dark table-borderless table-striped table-hover w-100">
    <thead>
      <tr>
        <th class="th-hover" scope="col" style="width:auto;">Id</th>
        <th class="th-hover" scope="col" style="width:auto;">Name</th>
        <th class="th-hover" scope="col" style="width:auto;">Email</th>
        <th class="th-hover" scope="col" style="width:auto;">Status</th>
        <th class="th-hover" scope="col" style="width:auto;">Account Type</th>
        <th class="th-hover" scope="col" style="width:auto;">Time</th>
      </tr>
    </thead>
  </table>
  <div>
