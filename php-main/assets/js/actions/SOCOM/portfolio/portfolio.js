...
function updateAllBudgetLineGraphs(tabType) {
    ...
    .then(results => {
        ...
        graphData.title = `Budgeting Trends ${graphData['categories'][0]} - ${graphData['categories'][graphData['categories'].length - 1]}`;
    ...
    Highcharts.chart(containerId, {
        ...
        yAxis: {
            ...
            stackLabels: {
                enabled: true,
                formatter: function () {
                    return formatLargeNumber(this.total); // Show total in formatted form
                }
            }
        },
        legend: {
...
function showAmsDataList(value) {
    ...
    for (const [key, values] of Object.entries(value)) {
        ...
        amsDataListHtmText += `<div class="bx--structured-list-row">
            <div class="bx--structured-list-td bx--structured-list-content--nowrap"><h5>${title}</h5></div>
